...
start_slave_stmt2="CHANGE MASTER TO MASTER_HOST='mysql_master',MASTER_USER='mydb_slave_user2',MASTER_PASSWORD='mydb_slave_pwd2',MASTER_LOG_FILE='$CURRENT_LOG',MASTER_LOG_POS=$CURRENT_POS; START SLAVE;"
